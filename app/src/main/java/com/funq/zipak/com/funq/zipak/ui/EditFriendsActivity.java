...
public class EditFriendsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGridView.setOnItemClickListener(msetOnItemClickListener);
...
//    }
    ...
    protected AdapterView.OnItemClickListener msetOnItemClickListener = new AdapterView.OnItemClickListener() {
        @Override
